...
<body>
    <h1> Hello this is the page when i read from the file ( data of the forum discussion) </h1>
    ...
    <?php 
        ...
        function with_fread ( ) {
            ...
            // Opening the file 
            $fp = fopen ( 'discussion_data.txt', 'r');

            $file_size = filesize('discussion_data.txt'); // by bytes ( en octet)
        ...
        function with_file_get_contents() {
            ...
            $content = file_get_contents( 'discussion_data.txt' );
        ...
        function with_file () {
            ...
            $content = file('discussion_data.txt'  );

            echo "<pre>".print_r( $content  ). "</pre>";

            // echo "-----------------------------";
            // $content2 = file('discussion_data.txt' , FILE_SKIP_EMPTY_LINES );
